...
- 看了来自 [Training my First NEURAL NETWORK in C++ and SFML - AI Tutorial](https://youtu.be/Zrrnqd0rCXg)，原本仓库地址 [Neural-network](https://github.com/Kofybrek/Neural-network)。这里用 xmake 包装了一下，可以直接编译运行，详细见 [src](src)

- 曾经用 js 重新实现过一遍，现在觉得 js 结构不够清晰

- 对于 cms 有了新的理解，想用 dart 重新实现一遍
